    ...
    <div className="flex h-screen bg-[#f8fafc] text-slate-900 font-sans overflow-hidden selection:bg-emerald-500 selection:text-white">
      ...
      <aside className="w-64 flex-none hidden md:flex flex-col p-6 text-white bg-[#0f2925] z-30">
        ...
        <nav className="flex-1 space-y-1.5 overflow-y-auto no-scrollbar">
          <div className="text-[10px] font-black text-teal-200/40 uppercase tracking-[0.2em] mb-4 px-3">Navigation</div>
          {navItems.map((item) => (
            <button
              key={item.id}
        ...
        <div className="mt-auto pt-6 border-t border-white/5">
            <div className="flex items-center gap-3 mb-5 px-2 bg-white/5 p-3 rounded-2xl border border-white/5">
      ...
      <div className="flex-1 flex flex-col h-full relative overflow-hidden bg-[#f8fafc]">
            ...
            <main className="flex-1 overflow-auto p-4 md:p-10 scroll-smooth w-full no-scrollbar">
